...
#define NUETRAL_CURRENT 506
#define MAX_CURRENT 50  //30 amps, each count equals .025 amps

#define Current_Max_Reverse NUETRAL_CURRENT - MAX_CURRENT 
#define Current_Max_Forward NUETRAL_CURRENT + MAX_CURRENT
...
{
		loop_count+=1;
	    current_sensor =  Get_Analog_Value (1);
		Current_Sum+= current_sensor;
		...
		if (loop_count == 10)
		{
			...
			loop_count = 0;
			Current_average = Current_Sum/10;

			if(Current_average > NUETRAL_CURRENT) //if going forward
				{			
				printf("Forward Current = %d Amps\n", (Current_average - NUETRAL_CURRENT) / 5); 
				}
			else                                 
				{
				printf("Reverse Current = %d Amps\n", (NUETRAL_CURRENT - Current_average) / 5);
				}
			
			if (Current_average > Current_Max_Forward)
			{
//				if(RIGHT_DRILL - ((Current_average-NUETRAL_CURRENT)*7)>127)
//					RIGHT_DRILL=RIGHT_DRILL - ((Current_average-NUETRAL_CURRENT)*7);
//				else
					New_right_drill = 127;
				printf("RIGHT_DRILL Too big: Original Speed = %d....New Speed = %d\n", (int)RIGHT_DRILL, (int)New_right_drill);
			}
			if (Current_average < Current_Max_Reverse)
			{
//				if(RIGHT_DRILL - ((NUETRAL_CURRENT-Current_average)*7)>127)
//					RIGHT_DRILL=RIGHT_DRILL - ((NUETRAL_CURRENT-Current_average)*7);
//				else
					New_right_drill = 127;
				printf("RIGHT_DRILL Too big: Original Speed = %d....New Speed = %d\n", (int)RIGHT_DRILL, (int)New_right_drill);
